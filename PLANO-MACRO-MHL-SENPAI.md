...
- **Referência visual aprovada:** [`prototipo-ui-clean.html`](prototipo-ui-clean.html) ([captura](prototipo-ui-clean.png)). Esta é a direção de design para a implementação: interface clean e clara, trilho azul de navegação, superfícies brancas, sombras suaves, hierarquia em quatro áreas (navegação global, work-items, conteúdo/artefatos e atividade contextual) e o conteúdo do artefato como elemento principal. O protótipo anterior, [`prototipo-ui.html`](prototipo-ui.html), permanece apenas como histórico e não deve orientar a linguagem visual da Fase 6.
