// A small, hand-picked set of stroke-based icons (Feather/Lucide-style:
// 24x24 viewBox, currentColor stroke) — no icon library dependency, just
// enough coverage for the chrome that used to rely on plain unicode glyphs
// (⌕, ⤢, ◈, ...), which read as placeholder-ish next to real UI icons.
const PATHS = {
